function adaptativas(vezes){
    ...
    for(i=0;i<vezes;i++){
        ...
        if (carta.nome){
            carta.classe('ouros');
            carta.classe('carta');
            // debug por ainda não ter os valores certos
            carta.descString = '<gambiarra><input type="button" value="X" class="xzinho"></gambiarra><h2>Ainda não tem :(</h2><p>Mas aqui está a carta, veja na página 39 do FastPlay</p>';
